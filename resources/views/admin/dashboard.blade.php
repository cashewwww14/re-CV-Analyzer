...
<body class="bg-gray-100">
    ...
    <div class="flex">
        ...
        <aside class="w-64 bg-white min-h-screen shadow-lg">
            <div class="p-6">
                <nav class="space-y-2">
                    <a href="{{ route('admin.dashboard') }}" class="flex items-center space-x-3 bg-blue-50 text-blue-700 px-4 py-3 rounded-lg font-semibold">
        ...
        <main class="flex-1 p-8">
            <div class="mb-8">
                ...
                <p class="text-gray-600">Welcome to CV Analyzer Admin Panel</p>
            </div>
